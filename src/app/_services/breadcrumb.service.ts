...
export class BreadcrumbService {
  ...
  private readonly routeConfig: Record<string, { label: string; parent?: string }> = {
    ...
    'exchanges': { label: 'Exchanges', parent: 'portfolio' },
    'exchange': { label: 'Exchange Details', parent: 'exchanges' },
    'markets': { label: 'Markets', parent: 'portfolio' },
    'strategies': { label: 'Strategies', parent: 'trading' },
    'backtester': { label: 'Backtester', parent: 'trading' },
